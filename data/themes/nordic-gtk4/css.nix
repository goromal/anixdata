...
@define-color wm_title shade(#d8dee9, 1.8);
@define-color wm_unfocused_title #8e95a4;
@define-color wm_highlight rgba(0, 0, 0, 0);
@define-color wm_borders_edge rgba(255, 255, 255, 0.1);
@define-color wm_bg_a shade(#434c5e, 1.2);
@define-color wm_bg_b #434c5e;
@define-color wm_shadow alpha(black, 0.35);
@define-color wm_border alpha(black, 0.18);
@define-color wm_button_hover_color_a shade(#434c5e, 1.3);
@define-color wm_button_hover_color_b #434c5e;
@define-color wm_button_active_color_a shade(#434c5e, 0.85);
...
@define-color budgie_tasklist_indicator_color #8fbcbb;
@define-color budgie_tasklist_indicator_color_active #8fbcbb;
...
* {
  ...
  outline-offset: -3px;
  outline-width: 0px;
  -gtk-secondary-caret-color: #8fbcbb; }
...
treeview.view rubberband {
  border: 1px solid #6fa9a8;
  background-color: rgba(111, 169, 168, 0.2); }
...
@keyframes needs_attention {
  from {
    background-image: radial-gradient(farthest-side, #bfd9d8 0%, rgba(191, 217, 216, 0) 0%); }
  to {
    background-image: radial-gradient(farthest-side, #bfd9d8 95%, rgba(191, 217, 216, 0)); } }
...
button.osd {
  ...
  button.osd:hover {
    color: white;
    border-color: #232831;
    background-image: linear-gradient(to bottom, rgba(65, 74, 91, 0.93), rgba(65, 74, 91, 0.93));
    background-clip: padding-box;
    text-shadow: 0 1px black;
    -gtk-icon-shadow: 0 1px black;
    outline-color: rgba(216, 222, 233, 0.3);
  ...
  button.osd:checked {
    color: white;
    border-color: #232831;
    background-image: linear-gradient(to bottom, rgba(52, 59, 73, 0.93), rgba(52, 59, 73, 0.93));
    background-clip: padding-box;
    text-shadow: none;
    -gtk-icon-shadow: none;
    outline-color: rgba(216, 222, 233, 0.3);
  ...
  button.osd:disabled {
    color: #808690;
    border-color: #232831;
    background-image: linear-gradient(to bottom, rgba(58, 63, 73, 0.5), rgba(58, 63, 73, 0.5));
    background-clip: padding-box;
    box-shadow: none;
    text-shadow: none;
    -gtk-icon-shadow: none;
  ...
  button.osd:backdrop {
    color: #d8dee9;
    border-color: #232831;
    background-image: linear-gradient(to bottom, rgba(40, 45, 55, 0.93), rgba(40, 45, 55, 0.93));
    background-clip: padding-box;
    box-shadow: none;
    text-shadow: none;
    -gtk-icon-shadow: none;
...
button.suggested-action {
  ...
  .osd button.suggested-action {
    ...
    .osd button.suggested-action:hover {
      color: white;
      border-color: #232831;
      background-image: linear-gradient(to bottom, rgba(94, 129, 172, 0.7), rgba(94, 129, 172, 0.7));
      background-clip: padding-box;
      text-shadow: 0 1px black;
      -gtk-icon-shadow: 0 1px black;
      outline-color: rgba(216, 222, 233, 0.3); }
    .osd button.suggested-action:active:backdrop, .osd button.suggested-action:active, .osd button.suggested-action:checked:backdrop, .osd button.suggested-action:checked {
      color: white;
      border-color: #232831;
      background-image: linear-gradient(to bottom, #5e81ac, #5e81ac);
      background-clip: padding-box;
      text-shadow: none;
      -gtk-icon-shadow: none;
      outline-color: rgba(216, 222, 233, 0.3); }
    ...
    .osd button.suggested-action:backdrop {
      color: #d8dee9;
      border-color: #232831;
      background-image: linear-gradient(to bottom, rgba(94, 129, 172, 0.5), rgba(94, 129, 172, 0.5));
      background-clip: padding-box;
      box-shadow: none;
      text-shadow: none;
      -gtk-icon-shadow: none; }
button.destructive-action {
  ...
  .osd button.destructive-action {
    color: #d8dee9;
    border-color: #232831;
    background-color: rgba(169, 68, 78, 0.5);
    background-clip: padding-box;
    text-shadow: 0 1px black;
    -gtk-icon-shadow: 0 1px black;
    outline-color: rgba(216, 222, 233, 0.3); }
    .osd button.destructive-action:hover {
      color: white;
      border-color: #232831;
      background-image: linear-gradient(to bottom, rgba(169, 68, 78, 0.7), rgba(169, 68, 78, 0.7));
      background-clip: padding-box;
      text-shadow: 0 1px black;
      -gtk-icon-shadow: 0 1px black;
      outline-color: rgba(216, 222, 233, 0.3); }
    .osd button.destructive-action:active:backdrop, .osd button.destructive-action:active, .osd button.destructive-action:checked:backdrop, .osd button.destructive-action:checked {
      color: white;
      border-color: #232831;
      background-image: linear-gradient(to bottom, #a9444e, #a9444e);
      background-clip: padding-box;
      text-shadow: none;
      -gtk-icon-shadow: none;
      outline-color: rgba(216, 222, 233, 0.3); }
    ...
    .osd button.destructive-action:backdrop {
      color: #d8dee9;
      border-color: #232831;
      background-image: linear-gradient(to bottom, rgba(169, 68, 78, 0.5), rgba(169, 68, 78, 0.5));
      background-clip: padding-box;
      box-shadow: none;
      text-shadow: none;
      -gtk-icon-shadow: none; }
...
.stack-switcher > button.needs-attention > image, stacksidebar row.needs-attention > label {
  ...
  background-image: radial-gradient(farthest-side, #bfd9d8 96%, rgba(191, 217, 216, 0));
...
entry, .linked > combobox > box > button.combo:dir(ltr), .linked > combobox > box > button.combo:dir(rtl) {
  ...
  box-shadow: none; }
  .inline-toolbar button:disabled, .linked > button:disabled, .linked:not(.vertical) > spinbutton:disabled:not(.vertical), .linked:not(.vertical) >
  entry:disabled, .linked > combobox > box > button.combo:disabled:dir(ltr), .linked > combobox > box > button.combo:disabled:dir(rtl) {
    color: #b9bfcb;
    border-color: rgba(35, 40, 49, 0.3);
    background-color: #404859;
    text-shadow: none;
...
spinbutton:not(.vertical), entry {
  ...
  .osd entry {
    ...
    .osd entry:disabled {
      color: #808690;
      border-color: #232831;
      background-color: rgba(58, 63, 73, 0.5);
      background-clip: padding-box;
      box-shadow: none;
      text-shadow: none;
      -gtk-icon-shadow: none; }
...
entry:not(:disabled) + spinbutton:not(:disabled):not(.vertical) {
  ...
  entry:not(:disabled) + spinbutton:not(:disabled):backdrop:not(.vertical) {
    border-top-color: #363d4c;
    background-image: linear-gradient(to bottom, #3d4455, #3d4455); }
...
scrolledwindow overshoot.top {
  background-image: radial-gradient(farthest-side at top, #4a5367 85%, rgba(74, 83, 103, 0)), radial-gradient(farthest-side at top, #4a5367, rgba(74, 83, 103, 0));
  ...
  scrolledwindow overshoot.top:backdrop {
    background-image: radial-gradient(farthest-side at top, #4a5367 85%, rgba(74, 83, 103, 0));
...
scrolledwindow overshoot.bottom {
  background-image: radial-gradient(farthest-side at bottom, #4a5367 85%, rgba(74, 83, 103, 0)), radial-gradient(farthest-side at bottom, #4a5367, rgba(74, 83, 103, 0));
  background-size: 100% 5%, 100% 100%;
  background-repeat: no-repeat;
  ...
  scrolledwindow overshoot.bottom:backdrop {
    background-image: radial-gradient(farthest-side at bottom, #4a5367 85%, rgba(74, 83, 103, 0));
    background-size: 100% 5%;
    background-repeat: no-repeat;
    background-position: center bottom;
    background-color: transparent;
...
scrolledwindow overshoot.left {
  background-image: radial-gradient(farthest-side at left, #4a5367 85%, rgba(74, 83, 103, 0)), radial-gradient(farthest-side at left, #4a5367, rgba(74, 83, 103, 0));
  ...
  scrolledwindow overshoot.left:backdrop {
    background-image: radial-gradient(farthest-side at left, #4a5367 85%, rgba(74, 83, 103, 0));
...
scrolledwindow overshoot.right {
  background-image: radial-gradient(farthest-side at right, #4a5367 85%, rgba(74, 83, 103, 0)), radial-gradient(farthest-side at right, #4a5367, rgba(74, 83, 103, 0));
  background-size: 5% 100%, 100% 100%;
  background-repeat: no-repeat;
  background-position: right center;
  background-color: transparent;
  ...
  scrolledwindow overshoot.right:backdrop {
    background-image: radial-gradient(farthest-side at right, #4a5367 85%, rgba(74, 83, 103, 0));
    background-size: 5% 100%;
    background-repeat: no-repeat;
    background-position: right center;
    background-color: transparent;
...
scrolledwindow junction {
  border-color: transparent;
  border-image: linear-gradient(to bottom, #232831 1px, transparent 1px) 0 0 0 1/0 1px stretch;
  background-color: #3f4758; }
  scrolledwindow junction:dir(rtl) {
    border-image-slice: 0 1 0 0; }
  scrolledwindow junction:backdrop {
    border-image-source: linear-gradient(to bottom, #262c36 1px, transparent 1px);
...
.titlebar:not(headerbar), .titlebar, headerbar {
  ...
  headerbar button {
    ...
    headerbar button.suggested-action {
      box-shadow: none;
      border: none;
      background-image: linear-gradient(to right, #5e81ac 0%, #5e81ac 100%); }
    ...
    headerbar button.titlebutton {
      ...
      headerbar button.titlebutton * {
        ...
        box-shadow: none;
        background-color: transparent; }
  .titlebar .linked > button, .titlebar .path-bar-box button,
  .titlebar headerbar .linked > button,
  headerbar .path-bar-box .titlebar button, .titlebar .linked > button:hover,
  .titlebar .linked > button:backdrop,
  .titlebar headerbar .linked > button,
  headerbar .path-bar-box .titlebar button,
  headerbar .titlebar .linked > button,
  headerbar .linked > button,
  headerbar .titlebar .path-bar-box button,
  .titlebar .path-bar-box headerbar button,
  ...
  headerbar .linked > button:backdrop {
    ...
    margin: 5px 0px;
    min-height: 20px; }
    .titlebar .linked > button:first-child, .titlebar .path-bar-box button:first-child,
    .titlebar headerbar .linked > button:first-child,
    headerbar .path-bar-box .titlebar button:first-child,
    headerbar .titlebar .linked > button:first-child,
    ...
    headerbar .titlebar .linked > button:last-child,
    ...
    headerbar .path-bar-box .titlebar button:only-child,
  ...
  headerbar .path-bar-box .titlebar button:active, .titlebar .linked > button:checked,
  .titlebar headerbar .linked > button:checked, .titlebar .path-bar-box button:checked,
  headerbar .path-bar-box .titlebar button:checked,
  headerbar .titlebar .linked > button:active,
  headerbar .linked > button:active,
  .titlebar .path-bar-box headerbar button:active,
  headerbar .path-bar-box button:active,
  headerbar .titlebar .linked > button:checked,
  headerbar .linked > button:checked,
  .titlebar .path-bar-box headerbar button:checked,
  headerbar .path-bar-box button:checked {
    ...
    .titlebar headerbar .linked > button:active:backdrop, .titlebar .path-bar-box button:active:backdrop,
    headerbar .path-bar-box .titlebar button:active:backdrop, .titlebar .linked > button:checked:backdrop,
    .titlebar headerbar .linked > button:checked:backdrop, .titlebar .path-bar-box button:checked:backdrop,
    headerbar .path-bar-box .titlebar button:checked:backdrop,
    headerbar .titlebar .linked > button:active:backdrop,
    headerbar .linked > button:active:backdrop,
    .titlebar .path-bar-box headerbar button:active:backdrop,
    headerbar .path-bar-box button:active:backdrop,
    headerbar .titlebar .linked > button:checked:backdrop,
    headerbar .linked > button:checked:backdrop,
    .titlebar .path-bar-box headerbar button:checked:backdrop,
    headerbar .path-bar-box button:checked:backdrop {
      color: rgba(46, 52, 64, 0.5); }
      .titlebar .linked > button:active:backdrop label, .titlebar .path-bar-box button:active:backdrop label,
      headerbar .path-bar-box .titlebar button:active:backdrop label, .titlebar .linked > button:checked:backdrop label, .titlebar .path-bar-box button:checked:backdrop label,
      headerbar .path-bar-box .titlebar button:checked:backdrop label,
      headerbar .linked > button:active:backdrop label,
      .titlebar .path-bar-box headerbar button:active:backdrop label,
      headerbar .path-bar-box button:active:backdrop label,
      headerbar .linked > button:checked:backdrop label,
      .titlebar .path-bar-box headerbar button:checked:backdrop label,
  ...
  headerbar .path-bar-box .subtitle {
    color: transparent;
    margin-right: -6px; }
  .titlebar .path-bar-box button:last-child,
  headerbar .path-bar-box button:last-child {
    margin-left: -1px;
    border-radius: 0px; }
  ...
  headerbar .path-bar-box widget > .text-button:last-child {
    ...
    background-color: rgba(143, 188, 187, 0.7);
    text-shadow: none; }
    .titlebar .path-bar-box widget > .text-button:last-child:backdrop, .titlebar .path-bar-box widget > .text-button:last-child:backdrop label,
  ...
  notebook > header.bottom {
    ...
    notebook > header.bottom > tabs {
      ...
      notebook > header.bottom > tabs > tab:checked {
        background-color: #3b4252;
        box-shadow: -1px 0 0 #232831, 0px 1px 0 #232831, 1px 0 0 #232831; }
  notebook > header.left {
    ...
    notebook > header.left > tabs {
      ...
      notebook > header.left > tabs > tab:checked {
        background-color: #3b4252;
        box-shadow: 0px 1px 0 #232831, 0px -1px 0 #232831, 0px 1px 0 #232831; }
  notebook > header.right {
    ...
    notebook > header.right > tabs {
      ...
      notebook > header.right > tabs > tab:checked {
        background-color: #3b4252;
        box-shadow: 0px 1px 0 #232831, 0px -1px 0 #232831, 1px 0 0 #232831; }
  ...
  notebook > header tab {
    ...
    notebook > header tab:checked {
      ...
      notebook > header tab:checked.reorderable-page {
        border-color: rgba(35, 40, 49, 0.5);
...
paned > separator {
  ...
  border-style: none;
  background-color: transparent;
  background-image: image(#232831);
  background-size: 1px 1px; }
  paned > separator:selected {
    background-image: image(#8fbcbb); }
  paned > separator:backdrop {
    background-image: image(#262c36); }
  paned > separator.wide {
    min-width: 5px;
    min-height: 5px;
    background-color: #434c5e;
    background-image: image(#232831), image(#232831);
    background-size: 1px 1px, 1px 1px; }
    paned > separator.wide:backdrop {
      background-color: #434c5e;
      background-image: image(#262c36), image(#262c36); }
...
placessidebar.sidebar {
  ...
  placessidebar.sidebar row.sidebar-row:selected {
    color: #fff;
    background-color: transparent;
    background-image: linear-gradient(to right, rgba(143, 188, 187, 0.7) 40px, rgba(65, 67, 75, 0) 36px, rgba(65, 67, 75, 0) 97%); }
    ...
    placessidebar.sidebar row.sidebar-row:selected:backdrop {
      ...
      background-color: transparent;
      background-image: linear-gradient(to right, #8fbcbb 40px, rgba(65, 67, 75, 0) 36px, rgba(65, 67, 75, 0) 97%); }
...
spinbutton:not(.vertical) {
  ...
  spinbutton:not(.vertical) button {
    ...
    spinbutton:not(.vertical) button:backdrop {
      color: #868d9c;
      background-color: transparent;
      border-color: rgba(38, 44, 54, 0.3);
      transition: 200ms ease-out; }
    spinbutton:not(.vertical) button:backdrop:disabled {
      color: rgba(99, 112, 139, 0.3);
      background-image: none;
      border-style: none none none solid;
      box-shadow: inset 1px 0px 0px 0px rgba(0, 0, 0, 0.07); }
...
.osd spinbutton:not(.vertical) button {
  ...
  color: #d8dee9;
  border-style: none none none solid;
  border-color: rgba(35, 40, 49, 0.7);
  border-radius: 0;
  box-shadow: none;
  -gtk-icon-shadow: 0 1px black; }
...
treeview.view {
  ...
  treeview.view:selected:backdrop, treeview.view:selected {
    border-left-color: #5f787e;
    border-top-color: rgba(216, 222, 233, 0.1); }
  treeview.view:disabled {
    color: #8e95a4; }
    treeview.view:disabled:selected {
      color: #68868a; }
      treeview.view:disabled:selected:backdrop {
        color: rgba(131, 171, 172, 0.85); }
  ...
  treeview.view.separator {
    ...
    treeview.view.separator:backdrop {
      color: rgba(67, 76, 94, 0.1); }
  treeview.view:backdrop {
    border-left-color: #697181;
    border-top: #434c5e; }
  ...
  treeview.view.progressbar {
    ...
    border-radius: 4px;
    background-color: #8fbcbb;
    background-image: linear-gradient(to bottom, #8fbcbb, #6fa9a8);
    ...
    treeview.view.progressbar:selected:focus, treeview.view.progressbar:selected {
      ...
      color: #8fbcbb;
      background-image: linear-gradient(to bottom, #3b4252, #262a34); }
  ...
  treeview.view header.button.dnd {
    ...
    border-radius: 0;
    border-style: none;
    box-shadow: inset 0 0 0 1px #3b4252;
    text-shadow: none; }
...
window {
  ...
  window.solid-csd {
    ...
    border-radius: 0;
    box-shadow: inset 0 0 0 4px #232831, inset 0 0 0 3px #353c4a, inset 0 1px rgba(216, 222, 233, 0.07); }
    window.solid-csd:backdrop {
      box-shadow: inset 0 0 0 4px #232831, inset 0 0 0 3px #434c5e, inset 0 1px rgba(216, 222, 233, 0.07); }
...
.titlebar.selection-mode button.titlebutton {
  text-shadow: 0 -1px rgba(0, 0, 0, 0.4807843137);
  -gtk-icon-shadow: 0 -1px rgba(0, 0, 0, 0.4807843137); }
...
.places-menu .places-section-header {
  padding: 0px;
  border-bottom: 1px solid rgba(35, 40, 49, 0.95);
...
.places-menu .unlock-area {
  border-top: 1px solid rgba(35, 40, 49, 0.85);
  border-bottom: 1px solid rgba(35, 40, 49, 0.85); }
...
.places-menu .unlock-area button {
  border-radius: 0;
  border: 0;
  border-left: 1px solid rgba(35, 40, 49, 0.85); }
...
.budgie-panel {
  ...
  .budgie-panel.transparent {
    background-color: rgba(32, 36, 44, 0.2); }
    ...
    .budgie-panel.transparent:backdrop, .budgie-panel.transparent label, .budgie-panel.transparent button.raven-trigger:backdrop, .budgie-panel.transparent button.budgie-menu-launcher {
      color: #f9fafb; }
...
.top .budgie-panel {
  border-bottom: 1px solid rgba(38, 43, 53, 0.92); }
...
.top .raven-frame {
  ...
  .top .raven-frame border {
    border: none;
    border-bottom: 1px solid rgba(35, 40, 49, 0.92); }
...
.bottom .budgie-panel {
  border-top: 1px solid rgba(38, 43, 53, 0.92); }
...
.bottom .raven-frame {
  ...
  .bottom .raven-frame border {
    border: none;
    border-top: 1px solid rgba(35, 40, 49, 0.92); }
...
.left .budgie-panel {
  border-right: 1px solid rgba(38, 43, 53, 0.92); }
...
.left .raven-frame {
  ...
  .left .raven-frame border {
    border: none;
    border-right: 1px solid rgba(35, 40, 49, 0.92); }
...
.right .budgie-panel {
  border-left: 1px solid rgba(38, 43, 53, 0.92); }
...
.right .raven-frame {
  ...
  .right .raven-frame border {
    border: none;
    border-left: 1px solid rgba(35, 40, 49, 0.92); }
...
.raven {
  ...
  .raven .raven-header {
    min-height: 32px;
    color: #d8dee9;
    border: solid rgba(35, 40, 49, 0.95);
    border-width: 1px 0;
    background-color: rgba(64, 72, 89, 0.45); }
    .raven .raven-header * {
      padding-top: 0;
      padding-bottom: 0; }
    ...
    .raven .raven-header > button.text-button {
      border-radius: 2px;
      color: #2e3440;
      background-color: rgba(184, 79, 89, 0.9);
      ...
      .raven .raven-header > button.text-button:active {
        color: #2e3440;
        background-color: rgba(198, 115, 123, 0.9);
        box-shadow: inset 0px 1px 0px 0px rgba(255, 255, 255, 0.1), inset 0px -1px 0px 0px rgba(0, 0, 0, 0.1); }
  ...
  .raven .powerstrip button.image-button {
    ...
    .raven .powerstrip button.image-button:hover {
      background: rgba(180, 142, 173, 0.85);
      color: #2e3440; }
    ...
    .raven .powerstrip button.image-button:first-child {
      ...
      .raven .powerstrip button.image-button:first-child:hover {
        background: rgba(143, 188, 187, 0.85); }
  ...
  .budgie-session-dialog .linked.horizontal > button, .budgie-polkit-dialog .linked.horizontal > button, .budgie-run-dialog .linked.horizontal > button {
    ...
    .budgie-session-dialog .linked.horizontal > button.suggested-action, .budgie-polkit-dialog .linked.horizontal > button.suggested-action, .budgie-run-dialog .linked.horizontal > button.suggested-action {
      ...
      .budgie-session-dialog .linked.horizontal > button.suggested-action:hover, .budgie-polkit-dialog .linked.horizontal > button.suggested-action:hover, .budgie-run-dialog .linked.horizontal > button.suggested-action:hover {
        background-color: rgba(159, 198, 197, 0.9); }
    ...
    .budgie-session-dialog .linked.horizontal > button.destructive-action, .budgie-polkit-dialog .linked.horizontal > button.destructive-action, .budgie-run-dialog .linked.horizontal > button.destructive-action {
      background-color: rgba(169, 68, 78, 0.9); }
...
.budgie-menubar arrow {
  ...
  .budgie-menubar arrow.top {
    -gtk-icon-source: -gtk-icontheme("pan-up-symbolic");
    border-bottom: 1px solid rgba(72, 79, 92, 0.928); }
  .budgie-menubar arrow.bottom {
    -gtk-icon-source: -gtk-icontheme("pan-down-symbolic");
    border-top: 1px solid rgba(72, 79, 92, 0.928); }
...
.workspace-switcher .workspace-layout {
  border: 0 solid rgba(32, 36, 44, 0.95); }
...
.workspace-switcher .workspace-item, .workspace-switcher .workspace-add-button {
  border: 0 solid rgba(53, 60, 74, 0.95); }
...
.workspace-switcher .workspace-item.current-workspace {
  background-color: rgba(21, 24, 29, 0.95); }
...
.nautilus-window .sidebar {
  ...
  .nautilus-window .sidebar .list-row button {
    ...
    .nautilus-window .sidebar .list-row button:active {
      background-color: rgba(143, 188, 187, 0.75); }
...
.notify {
  ...
  background-color: rgba(59, 66, 82, 0.05); }
...
.button.app {
  ...
  .button.app .app:hover {
    border-radius: 8px;
    border: none;
    background-color: rgba(143, 188, 187, 0.3);
    color: white; }
...
.sidebar .source-list.view.level-bar, .sidebar iconview.source-list.level-bar, .sidebar .source-list.view.level-bar:selected, .sidebar iconview.source-list.level-bar:selected, .sidebar .source-list.view.level-bar:selected:focus, .sidebar iconview.source-list.level-bar:selected:focus {
  background: linear-gradient(to right, #4e586d, #4e586d);
...
.sidebar .source-list.view.fill-block, .sidebar iconview.source-list.fill-block, .sidebar .source-list.view.fill-block:hover, .sidebar iconview.source-list.fill-block:hover, .sidebar .source-list.view.fill-block:selected, .sidebar iconview.source-list.fill-block:selected, .sidebar .source-list.view.fill-block:selected:focus, .sidebar iconview.source-list.fill-block:selected:focus {
  background: linear-gradient(to right, #ebcb8b, #ebcb8b); }
...
MsdOsdWindow.background.osd {
  ...
  MsdOsdWindow.background.osd .trough {
    background-color: rgba(29, 33, 40, 0.93);
    border: none;
    border-radius: 5px; }
...
.thunar toolbar .path-bar-button {
  ...
  background-color: #2e3440;
  border-radius: 0;
  border-right: 0.5px solid #232831;
  box-shadow: none;
  min-height: 20px;
  padding: 3px 4px; }
...
window.thunar paned > scrolledwindow treeview.view:hover, window.thunar paned > scrolledwindow treeview.view:selected {
  background: rgba(143, 188, 187, 0.7);
  color: #2e3440;
  border-radius: 0;
  box-shadow: none; }
